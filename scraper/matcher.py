...
CATEGORY_MAP = {
    ...
    # социални покрива и здравеопазване — стари абонати със "социални"
    # получаваха здравните записи преди отделянето на категорията (юли 2026)
    "социални":   ["социални", "здравеопазване", "общи"],
    "здравеопазване": ["здравеопазване", "общи"],
